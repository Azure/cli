...
exports.createScriptFile = function (inlineScript) { return __awaiter(void 0, void 0, void 0, function () {
    var fileName, filePath;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                fileName = "AZ_CLI_GITHUB_ACTION_" + exports.getCurrentTime().toString() + ".sh";
                filePath = path.join(exports.TEMP_DIRECTORY, fileName);
                fs.writeFileSync(filePath, "" + inlineScript);
                return [4 /*yield*/, exports.giveExecutablePermissionsToFile(filePath)];
            case 1:
                _a.sent();
...
exports.giveExecutablePermissionsToFile = function (filePath) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    switch (_a.label) {
        case 0: return [4 /*yield*/, exec.exec("chmod +x " + filePath, [], { silent: true })];
