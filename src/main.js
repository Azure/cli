    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, cs.credscan(inlineScript, scannedResult, 0)];
            case 3:
                            ...
                            stdout: function (data) { return __awaiter(void 0, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            scannedResult = { result: null };
                                            return [4 /*yield*/, cs.credscan(data.toString(), scannedResult, 0)];
                                        case 1:
                            ...
                            errline: function (data) { return __awaiter(void 0, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            scannedResult = { result: null };
                                            return [4 /*yield*/, cs.credscan(data, scannedResult, 0)];
                                        case 2:
                                            temporaryVariable = _a.sent();
                                            // if(!scannedResult.result) console.log(data.toString());
