                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            ...
                                            return [3 /*break*/, 5];
                                        case 2:
                                            if (!(config.credScanEnable || process.env.CREDSCAN)) return [3 /*break*/, 4];
                            ...
                            errline: function (data) { return __awaiter(void 0, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            scannedResult = { result: null };
                                            if (!!config.credScanEnable) return [3 /*break*/, 2];
                                            console.log(data);
                                            return [3 /*break*/, 6];
                                        case 2:
                                            if (!!process.env.CREDSCAN) return [3 /*break*/, 3];
                                            console.log(data);
                                            return [3 /*break*/, 6];
                                        case 3:
                                            if (!(config.credScanEnable || process.env.CREDSCAN)) return [3 /*break*/, 5];
