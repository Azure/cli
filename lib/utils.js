...
exports.createScriptFile = function(inlineScript) {
...
exports.giveExecutablePermissionsToFile = function(filePath) {
    return __awaiter(void 0, void 0, void 0, function() {
        return __generator(this, function(_a) {
            switch (_a.label) {
                case 0:
                    return [4 /*yield*/ , exec.exec("chmod +x " + filePath, [], { silent: true })];
                case 1:
