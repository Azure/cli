...
// const credscan(input){credScanFunction(input, function(error, result) {
...
// async function credscan(input){
//   console.log("INSIDE CRED SCAN ")
//   let result = await credScanFunction(input)
//   if (input.toString() !== result.toString()) {
//     core.warning('Credentials were found.');
//   }
//   var strinput = input.toString();
